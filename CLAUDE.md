...
Follow `docs/agent-readiness.md` for public routes, localization, discovery, skills,
content negotiation, and release checks. Preserve the local-only calculation
boundary. Never advertise unimplemented protocols to satisfy a scanner.
